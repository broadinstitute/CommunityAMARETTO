...
legend(x = 1.5, y = 1.5, legend=names(cAMARETTOnetworkC$color_list), col=cAMARETTOnetworkC$color_list, pch=19, bty="n",cex=max(0.9,1/(1+0.02*length(cAMARETTOnetworkC$color_list))),ncol=ceiling(length(cAMARETTOnetworkC$color_list)/15))
```
<br><br><br>
