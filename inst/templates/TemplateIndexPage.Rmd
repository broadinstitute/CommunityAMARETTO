...
legend(x = 1.5, y = 1.5, legend=names(cAMARETTOnetworkC$color_list), col=cAMARETTOnetworkC$color_list, pch=19, bty="n",cex=1/(1+0.02*length(names(cAMARETTOnetworkC$color_list))))
```
<br><br><br>
