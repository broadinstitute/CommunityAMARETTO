...
Development of regulatory network inference algorithms using
multi-omics data is a highly sought area of researcher[].
These networks attemp to infer the gene regulatory circuits specific
to biological systems and therfore lead to the enhanced understanding
of regulatory mechanisms as well as discovering biomarkers of diseases
and cancer systems.  

These regulatory network inference algorithms are specifically applied to
individual biological systems; Integrating multiple regulatory networks across
biological systems allows for disocry of shared and
distinct biological mechanism. 

We developed Community-AMARETTO algorithm to integrate multiple
regulatory networks more specifically inferred by AMARETTO algorithm.
Community-AMARETTO detectes communities of circutis that are shared 
across biological systems as well as highlights
circuts that are system specific. 

Here, we provided a sample case study realted to liver to demonstate
the general steps that should be taken during Community-AMARETTO analysis. 
Sample case study includes three biological systems of 1) Liver Cancer,
2) Hepatite C and 3) Hepatite B, each inferred by AMARETTO algorithm
for gene regulatory network inference. In this note, we show how to integrate
these networks through Community-AMARETTO algorithm as well as perform
downstream analyis such as functional enrichment of detected communities
as well as generating HTML-report.
