...
```{r Installations, message= FALSE,warning=FALSE,results='hide'}
#-------------------------------------------------------------------------------
...
```{r cAMARETTOanalysis , message= FALSE,warning=FALSE,results='hide'}
#-------------------------------------------------------------------------------
...
```{r FuntionalEnrichment, message= FALSE,warning=FALSE,results='hide'}
...
```{r HTMLreport, message= FALSE,warning=FALSE,results='hide'}
