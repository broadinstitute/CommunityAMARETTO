...
The package  is accessible via Bioconductor as the most stable version. However, you can install the newest features from the development branch of our github. The package should be installed once in your system. Here is the installation code : 
