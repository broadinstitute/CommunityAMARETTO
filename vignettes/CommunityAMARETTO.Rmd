...
author:
    ...
    Broad Institute of MIT and Harvard, Boston and Cambridge, MA, USA
    ...
    - name: Shaimaa Bakr
    affiliation: Stanford Center for Biomedical Informatics Research (BMIR),
    Department of Medicine and Biomedical Data Science,
    1265 Welch Rd, Stanford, CA, USA
...
abstract: |
    ...
    networks inferred using the AMARETTO algorithm[reference] that are based
...
package: Report issues on [https://github.com/broadinstitute/CommunityAMARETTO/]
(https://github.com/broadinstitute/CommunityAMARETTO/)
vignette: |
...
The package is accessible via Bioconductor as the most stable version.
However, you can install the newest features from the development branch
of our github. The package should be installed once in your system.
