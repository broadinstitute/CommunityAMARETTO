...
vignette: >
  %\VignetteIndexEntry{Community AMARETTO}
...
```
```{r}
# samples_TCGA<-readr::read_delim('../inst/extdata/Samples_LIHC_phenotypes.txt','\t')
# phenotype_tests_TCGA<-readr::read_delim("../inst/extdata/Samples_LIHC_statistics.txt",delim="\t",col_names=TRUE)
```
...
```{r}
# cAMARETTOresults<-cAMARETTO_Results(AMARETTOinit_all_75,AMARETTOresults_all_75,gmt_filelist=gmt_filelist,NrCores = 4,output_dir = "./",drivers=TRUE)
...
# 
# HTMLsAMARETTOlist <- c("TCGA"='html_report_TCGA_address',"CCLE"='html_report_CCLE_address')
# 
# 
# 
# cAMARETTO_HTMLreport(cAMARETTOresults,cAMARETTOnetworkM, cAMARETTOnetworkC,HTMLsAMARETTOlist=HTMLsAMARETTOlist,CopyAMARETTOReport = FALSE, hyper_geo_test_bool = FALSE, hyper_geo_reference = './H_C2_genesets.gmt', MSIGDB = TRUE,output_address= "./",PhenotypeTablesList=PhenotypeTables)
